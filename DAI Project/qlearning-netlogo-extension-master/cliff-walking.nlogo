...
to setup
  ...
  ask patches with [pxcor = 2 and pycor > 0 and pycor < 4][set pcolor blue set reward -100 set plabel reward]

  ask patches with [pxcor = 4 and pycor > 1 and pycor < 5][set pcolor blue set reward -100 set plabel reward]
